...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // --- Создание тегов ---
        $tagEducation = $user->tags()->create(['name' => 'Обучение', 'color' => 'yellow']);
        $tagSport = $user->tags()->create(['name' => 'Спорт', 'color' => 'blue']);
        $tagArt = $user->tags()->create(['name' => 'Творчество', 'color' => 'red']);

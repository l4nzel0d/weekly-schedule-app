                        ...
                        <div>
                            ...
                            @foreach ($colors as $color)
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="bootstrap_color_class" id="edit-tag-color-{{ $color }}" value="{{ $color }}">
                                    <label class="form-check-label badge text-bg-{{ $color }}" for="edit-tag-color-{{ $color }}">{{ ucfirst($color) }}</label>
                                </div>
                            @endforeach
                        </div>
                    </div>
